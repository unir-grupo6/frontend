...
updateShownRutinas() {
  ...
  // Aquí puedes implementar la lógica para generar una rutina personalizada
  // Por ejemplo, podrías abrir un modal o redirigir a otra página
  console.log('Generar rutina personalizada');

  const generatedRoutine: IAutogeneratedRoutine = await this.routinesListService.generateRoutine();
  ...
  for (const exercise of generatedRoutine.ejercicios) {
    ejercicios.push({
      ...
      tipo: 'Desconocido', // exercise.tipo || 'Desconocido',
      step_1: 'Desconocido', // exercise.step_1 || 'Desconocido',
      step_2: 'Desconocido', // exercise.step_2 || 'Desconocido',
      grupos_musculares: 'Desconocido', // exercise.grupos_musculares || 'Desconocido',
    });
  }
